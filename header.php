...
$before_head = ''; // Set a default value for $before_head
$after_body = ''; // Set a default value for $after_body
$contact_phone = '123-456-7890'; // Set your contact phone number here
$contact_email = 'info@example.com'; // Set your contact email here
